...
from sql_parameters_EDIT_THIS import (
    start_date, end_date, product_class, product_group, serve_format, serve_format_predicate, product_group_predicate, cs_database
)
...
data_lad_cs = pd.read_sql(sql_query, engine)