...
from l_identify_activation_product_stocking import df
...
c["product_comp_stocks_control_product"] = np.select(conditions, choices)

# Reduce the columns.
c = c[["outlet", "product_comp_stocks_control_product"]]
...
c["product_act_stocks_control_product"] = np.select(conditions, choices)

# Reduce the columns.
c = c[["outlet", "product_act_stocks_control_product"]]
